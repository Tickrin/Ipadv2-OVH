...
<div class="fond">	
	<div class="container">
		...
		<div class="titre">
			<div class="logo">
				<a href="../admin/tdb.php"> <img src="../logos/<?php echo $_SESSION['Logos']; ?>" alt="" class="responsiveimgs"></a>
			</div>
			<div class="nomOp">
				<?php echo $_SESSION["NomEve"]; ?>
				<br>
				<span><?php echo $_SESSION["NomOpe3"]; ?></span>
			</div>
		</div>
		...
		<div class="corps">
			<table border="0">
				<tr>
					<td height="50px">
						<span style="font-size:2vw; font-weight:bold;color:red;"> Questions </span>
					</td>
					<td align="middle">
						<span style="font-size:1.5vw; font-weight:bold;color:red;">Nbr de votes</span>
					</td>
				</tr>
				<?php 
